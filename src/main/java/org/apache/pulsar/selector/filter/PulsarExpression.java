 ...
 */
package org.apache.pulsar.selector.filter;
 ...
 */
public abstract class PulsarExpression extends BinaryExpression {
     ...
     * @param right
     */
    public PulsarExpression(Expression left, Expression right) {
        super(left, right);
        convertStringExpressions = ComparisonExpression.CONVERT_STRING_EXPRESSIONS.get() != null;
    }

    public static Expression createPlus(Expression left, Expression right) {
        return new PulsarExpression(left, right) {
            @Override
