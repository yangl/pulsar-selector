...
import org.apache.pulsar.selector.filter.FilterException;
import org.apache.pulsar.selector.filter.Filterable;
...
public class SelectorTest {
    ...
    public void testLike() throws Exception {
        ...
        assertSelector(message,
                "modelClassId LIKE 'com.whatever.something.%' AND modelInstanceId = '170' AND (modelRequestError IS "
                        + "NULL OR modelCorrelatedClientId = 'whatever')",
                true);
